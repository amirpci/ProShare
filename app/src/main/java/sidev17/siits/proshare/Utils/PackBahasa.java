...
public class PackBahasa {
    public static String[][] bahasaProfile = {{"You answered","Your rating","questions", "Your skills and recommendations"},
                                                {"Anda menjawab", "Rating Anda", "pertanyaan", "Keahlian dan rekomendasi Anda"},
                                                {"あなたは答えた", "あなたの評価", "質問", "あなたのスキルと推奨事項"}};
    public static String[][] bahasaStatusAkun = {{"Worker", "Expert", "Verified Expert"},
                                                {"Pekerja", "Ahli", "Ahli Terverifikasi"},
                                                {"ワーカー", "エキスパート", "認証エキスパート"}};
    public static String[][] settingPilihanBahasa = {{"English", "Indonesian", "Japanese"},
                                                    {"Bahasa Inggris", "Bahasa Indonesia", "Bahasa Jepang"},
                                                    {"English", "Bahasa Indonesia", "日本語"}};
    public static String[][] yesNo = {{"Ok", "Cancel"},{"Ya", "Batal"}, {"はい", "キャンセルします"}};
    public static String[][] setting = {{"Settings", "Account", "Change password", "Logout", "Close Account", "Language", "Change langage", "Select Language", "Please type your password!", "Authenication failed!", "Account deleted!"},
                                        {"Pengaturan", "Akun", "Ganti password", "Logout", "Hapus Akun", "Bahasa", "Ganti bahasa", "Pilih Bahasa", "Tolong masukkan password Anda!", "Autentikasi gagal!", "Akun telah dihapus!"},
                                        {"設定","アカウント","パスワードの変更","ログアウト","アカウントの閉鎖","言語","言語の変更", "言語を選択する", "パスワードを入力してください", "認証に失敗しました", "アカウントを削除しました"}};
    ...
    public static String[][] bahasaTimeline = {{"ask your question", "Sorry, no one has the same problem", "Ask now!", "Solution", "FAQ", "Share", "See", "other solutions", "empty :("},
            {"tanyakan masalah anda", "Mohon maaf, tidak seorang pun memiliki masalah sama", "Tanyakan sekarang!", "Solusi", "FAQ", "Berbagi", "Lihat", "solusi lainnya", "kosong :("},
            {"あなたの質問をする", "申し訳ありませんが、誰も同じ問題を抱えていません", "今すぐ聞く", "溶液", "よくある質問","共有", "他の","つの解決策を見る", "空っぽ :("}};
    public static String[][] chat = {{"Friends", "Find friend by email", "your friend's email", "Email not found!", "search here..."},
                                    {"Teman", "Cari teman dengan email", "email teman anda", "Email tidak ditemukan!", "cari di sini..."},
                                    {"友達","メールで友達を探す","友達のメールアドレス","メールが見つかりません！", "検索", "よくある質問", "共有"}};
    ...
    public static String[][] mainToast = {{"Please press BACK again to exit"},
            {"Tolong tekean tombol KEMBALI untuk keluar"}, {"もう一度押して終了してください"}};

    public static String[][] gantiPassword = {{"Please fill the blank!", "Password doesn't match!", "Password should have at least 6 character length!", "Password should contain letter and number!", "Password updated", "Error password not updated"},
    ...
    public static String[][] harusJawab = {{"Questions", "Shares"}
                                            ,{"Pertanyaan", "Share"},
                                                    {"質問","シェア"}};
    public static String[][] detilPertanyaan = {{"Solution", "Url :"}, {"Solusi", "Url"}, {"溶液"}};
